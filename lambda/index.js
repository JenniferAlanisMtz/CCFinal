...
var estadoPartida = 0;
var pregunta = 0;
var desbug = "Funciona otra vezzzzz"
var objetoUno
var objetoDos
var objetoTres
var pista;
...
const YesIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if(estadoPartida === 0 && pregunta === 0){
            ...
            <voice name="Lupe"> <amazon:domain name="news"> <audio src="soundbank://soundlibrary/radios_static/radios_static_06"/> En los intentos de encontrar a Ryo Yamada, que lleva en el bosque Kokura desde el 9 de abril, se ha perdido también una mujer llamada Hana Okada que era parte del equipo de búsqueda. Se ha determinado que es demasiado peligroso seguir mandando personas, por lo que los intentos de búsqueda han terminado... </amazon:domain> </voice> <audio src="soundbank://soundlibrary/radios_static/radios_static_06"/>
            Silencias el radio, eres el nuevo detective del pueblo y has decidido tomar este caso que todos dan por muerto, ahora mismo te diriges en un auto a aquel bosque. 
        ...
        if(pregunta === 9){
            if(primero !== "0" || segundo !== "3" || tercero !== "1" || cuarto !== "0"){
                if((objetoUno === "grabadora" || objetoDos === "grabadora" || objetoTres === "grabadora") && intentos === 1){
                    speakOutput = `Te voy a dar una pista. Lo bueno es que traes una grabadora y has guardado lo siguiente. ` + pista + `¿Cuál es el PIN? Puedes repetir lo que dice la grabadora diciendo reproducir`
            ...
            case 2:
                if(numero === "1"){
                    ...
                    if(objetoUno === "cinta metrica" || objetoDos === "cinta metrica" || objetoTres === "cinta metrica" || objetoUno === "cinta" || objetoDos === "cinta" || objetoTres === "cinta" || objetoUno === "cinta métrica" || objetoDos === "cinta métrica" || objetoTres === "cinta métrica" ){
                        speakOutput = speakOutput + `Genial, llevas una cinta métrica la usas para medir la huella, parece ser de hombre. ¡Qué raro!, la que desapareció es una chica, alguien más debe andar por aquí.`
                    ...
                    speakOutput = `Sigues mirando alrededor y encuentras una huella fresca frente a ti que obviamente no es tuya, parece ser de hombre, le indicas a Scraps que siga el rastro que haya dejado, te lleva hasta una tienda de campaña.
                    Investigas pero sólo han quedado atrás unas cuantas cobijas, trastes vacíos y unas notas casi indescifrables de las que logras entender:
                    ¿Hay salida de este bosque? Respuesta: Intercambio
                    Dirección: Norte
                    El rastro de huellas todavía no termina. ¿Qué quieres hacer?
                    Uno. Ir al norte.
                    Dos. Seguir las huellas.`
                    
                    ultimo = speakOutput
                    pregunta = 16
                } else {
                    speakOutput = `Scraps te guía hacia algo que está colgando de una rama, te acercas y observas que es un pedazo de tela, al parecer es de una blusa de mujer.
            ...
            case 4:
                if(numero === "1"){
                    ...
                    if(objetoUno === "cuerda" || objetoDos === "cuerda" || objetoTres === "cuerda"){
                        speakOutput = speakOutput + ` ¡Genial!, traes una cuerda en tu inventario y la usas para bajar. Rápidamente tomas la mochila y regresas con Scraps. 
...
//AQUI LA ULTIMA PISTA QUE AGREGUE                        
            ...
            case 5:
                if(numero === "1"){
                    ...
                    if(objetoUno === "bateria portatil" || objetoDos === "bateria portatil" || objetoTres === "bateria portatil" || objetoUno === "bateria" || objetoDos === "bateria" || objetoTres === "bateria" || objetoUno === "batería portátil" || objetoDos === "batería portátil" || objetoTres === "batería portátil" || objetoUno === "batería" || objetoDos === "batería" || objetoTres === "batería"){
                        speakOutput = speakOutput + ` De inmediato lo conectas a la batería portátil que traes, qué bueno que decidiste traerla, esperas unos minutos antes de volver a intentar prenderlo.
                        Esta vez lo logras y el celular inicia, pero al intentar desbloquearlo te pide un pin de 4 dígitos.
                        ¿Cuál es el PIN?`
                        ultimo = speakOutput
                        pregunta = 9
                    }else {
                        speakOutput = speakOutput + ` ¡Lástima! No traes la batería portátil, deberás seguir buscando. ¿Qué quieres hacer?
                        Uno. Seguir buscando en el río
                        Dos Decirle a Scraps que siga el rastro de las huellas`
            ...
            case 7:
                if(numero === "1"){
                    ...
                    if(objetoUno === "cuerda" || objetoDos === "cuerda" || objetoTres === "cuerda"){
                        speakOutput = speakOutput + ` Lo bueno es que traes una cuerda y la usas para bajar. Rápidamente tomas la mochila y regresas con Scraps. 
                        Al buscar dentro de ella encuentras la identificación de Hana Okada y varios cuadernos. 
                        Empiezas a hojearlos, sólo hablan de varias materias escolares, de repente se cae una nota con el número 0310, pero no le encuentras significado por lo que continúas. Entre uno de los cuadernos encuentras un recorte de periódico que dice... <voice name="Lupe"> <amazon:domain name="news">¡Ha sucedido de nuevo! La leyenda local cuenta que una vez que entras al bosque Kokura no hay salida...</amazon:domain> </voice>
                        <audio src="soundbank://soundlibrary/animals/amzn_sfx_dog_med_bark_2x_03"/>
                        Scraps está avisando. ¿Qué quieres hacer? 
            ...
            case 8:
                if(numero === "1"){
                    ...
                    if(objetoUno === "botiquín" || objetoDos === "botiquín" || objetoTres === "botiquín" || objetoUno === "botiquin" || objetoDos === "botiquin" || objetoTres === "botiquin"){
                        speakOutput = speakOutput + "Usas el botiquín que tienes en el inventario, qué bueno que decidiste traerlo, y Scraps se recupera como si no le hubiera sucedido nada, así que podrá seguir ayudándote."
                    }else{
            ...
            case 16:
                if(numero === "1"){
                    speakOutput = `Vas al norte y encuentras una cabaña a medio construir. Tratas de entrar pero la puerta está bloqueada. ¿Qué quieres hacer?
                    Uno. Buscar la llave por ahí cerca.
                    Dos. Irte y seguir buscando por otro lado`
                    pregunta = 20
                } else {
                    speakOutput = `Sigues las huellas y te dirigen a una cueva. Pero...`
                    if(objetoUno === "linterna" || objetoDos === "linterna" || objetoTres === "linterna"){
                        speakOutput = speakOutput + `¡Qué suerte! Traes una linterna en tu inventario por lo que te adentras en ella. Parece que caminas en círculos, todo se ve igual. ¿Qué quieres hacer?
                        Uno. Seguir adelante.
                        Dos. Regresar por donde viniste.`
                        pregunta = 20
                    }else{
                        speakOutput = speakOutput + `No traes la linterna, será difícil encontrar tu camino en la oscuridad. ¿Qué quieres hacer?
                        Uno. Adentrarse en la cueva.
                        Dos. Seguir buscando fuera de la cueva.`
                        pregunta = 20
                    }
                    ultimo = speakOutput
                }
            ...
            case 17:
                if(numero === "1"){
                    speakOutput = `Decides seguir el río pues al ser una fuente de agua, Hana pudo haber decidido quedarse cerca de él. Continuación en Can CLues 2.0. ¿Quieres intentarlo de nuevo?`
                    pregunta = 11
                } else {
                    speakOutput = `Vas al norte y encuentras una cabaña a medio construir. Tratas de entrar pero la puerta está bloqueda. ¿Qué quieres hacer?
                    Uno. Buscar la llave por ahí cerca.
                    Dos. Irte y seguir buscando por otro lado`
                    pregunta = 20
                }
            ...
            break;
            case 20:
                speakOutput = `Continuación en Can Clues 2.0 ¿Quieres intentarlo de nuevo?`
                pregunta = 11
            break;
            case 21:
                if(numero === "1"){
                    speakOutput =`Decides continuar, parece que en realidad sólo estabas camiando en espiral y has llegado al centro. Hay una roca con unos dibujos extraños. De repente Scrpas insiste en salir de la cueva.
                    ¿Qué quieres hacer?
                    Uno. Seguir mirando.
                    Dos. Salir en ese momento`
                    pregunta = 20
                } else {
                    speakOutput = `Sales de la cueva sano y salvo junto con Scraps, te sientes un poco avergonzado de sentir miedo, pero tienes que continuar con la investigación. ¿Qué quieres hacer?
                    Uno. Buscar si puedes hacer una antorcha con algo que haya alrededor.
                    Dos. Irte y buscar en otro lado`
                    pregunta = 20
                }
                ultimo = speakOutput
            break;
...
const PuertaIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if((primera === "K" || primera === "k") && (segunda === "O" || segunda === "o") && (tercera === "K" || tercera === "k") && (cuarta === "U" || cuarta === "u") && (quinta === "R" || quinta === "r") && (sexta === "A" || sexta === "a")){
            ...
            speakOutput = `<audio src="soundbank://soundlibrary/clocks/clock/clock_01"/> No se abrió, te voy a dar una pista. Por suerte has traido una grabadora y has guardado lo siguiente. ` + pista + `¿Cuál es la contraseña? Puedes repetir lo que dice la grabadora diciendo reproducir`
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Para elegir tu respuesta sólo basta con que digas 1 o 2. Si quieres volver a oír lo último que se dijo di repite';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Se ha guardado la partida en este momento.';
